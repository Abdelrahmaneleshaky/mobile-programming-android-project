...
public class Activity6 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Activity6.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int itemmPrice = basePrice * quantity;
    ...
    private void shareImage() {
        ...
        try{
            ...
            intent.putExtra(Intent.EXTRA_TEXT,"ps5 For 1500$");
